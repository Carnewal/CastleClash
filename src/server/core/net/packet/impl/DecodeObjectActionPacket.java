...
import server.world.entity.player.minigame.CastleClash;
                    ...
                    public void run() {
                        if (Misc.canClickObject(player.getPosition(), new Position(objectX, objectY, player.getPosition().getZ()), objSize)) {
                            ...
                            switch (objectId) {
                                ...
                                case 4408:
                                    //NpcDialogue.threeOptions(player, "Melee", "Ranged", "Magic");
                                    
                                    ((CastleClash) MinigameFactory.getMinigames().get("Castle Clash")).addPlayer(player);
