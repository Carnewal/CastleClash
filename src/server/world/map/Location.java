...
public class Location {
    ...
    public static boolean inMultiCombat(Entity entity) {
        return (entity.getPosition().getX() >= 3136 && entity.getPosition().getX() <= 3327 && entity.getPosition().getY() >= 3519 && entity.getPosition().getY() <= 3607) 
                || (entity.getPosition().getX() >= 3190 && entity.getPosition().getX() <= 3327 && entity.getPosition().getY() >= 3648 && entity.getPosition().getY() <= 3839) 
                || (entity.getPosition().getX() >= 3200 && entity.getPosition().getX() <= 3390 && entity.getPosition().getY() >= 3840 && entity.getPosition().getY() <= 3967) 
                || (entity.getPosition().getX() >= 2992 && entity.getPosition().getX() <= 3007 && entity.getPosition().getY() >= 3912 && entity.getPosition().getY() <= 3967) 
                || (entity.getPosition().getX() >= 2946 && entity.getPosition().getX() <= 2959 && entity.getPosition().getY() >= 3816 && entity.getPosition().getY() <= 3831) 
                || (entity.getPosition().getX() >= 3008 && entity.getPosition().getX() <= 3199 && entity.getPosition().getY() >= 3856 && entity.getPosition().getY() <= 3903) 
                || (entity.getPosition().getX() >= 3008 && entity.getPosition().getX() <= 3071 && entity.getPosition().getY() >= 3600 && entity.getPosition().getY() <= 3711) 
                || (entity.getPosition().getX() >= 3072 && entity.getPosition().getX() <= 3327 && entity.getPosition().getY() >= 3608 && entity.getPosition().getY() <= 3647) 
                || (entity.getPosition().getX() >= 2624 && entity.getPosition().getX() <= 2690 && entity.getPosition().getY() >= 2550 && entity.getPosition().getY() <= 2619) 
                || (entity.getPosition().getX() >= 2371 && entity.getPosition().getX() <= 2422 && entity.getPosition().getY() >= 5062 && entity.getPosition().getY() <= 5117) 
                || (entity.getPosition().getX() >= 2896 && entity.getPosition().getX() <= 2927 && entity.getPosition().getY() >= 3595 && entity.getPosition().getY() <= 3630) 
                || (entity.getPosition().getX() >= 2892 && entity.getPosition().getX() <= 2932 && entity.getPosition().getY() >= 4435 && entity.getPosition().getY() <= 4464) 
                || (entity.getPosition().getX() >= 2256 && entity.getPosition().getX() <= 2287 && entity.getPosition().getY() >= 4680 && entity.getPosition().getY() <= 4711)
                
                
                || (entity.getPosition().getX() >= 2365 && entity.getPosition().getX() <= 2431 && entity.getPosition().getY() >= 3072 && entity.getPosition().getY() <= 3135);
    }
